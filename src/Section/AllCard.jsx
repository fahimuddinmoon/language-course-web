    ...
    return (
        ...
        <div>
            <div className='py-5 text-center'>
                <h2 className='text-3xl font-bold my-2 p-2'>
                    Sell Your Property Faster Than Ever
                </h2>
                <p className='text-sm font-bold my-3 text-gray-400 p-2'>
                    Use our platform to sell your property. Get the best value and close deals quickly.
                </p>
            </div>
            <div className="py-6  sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-8 px-9">
                {
